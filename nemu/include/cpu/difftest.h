...
#else
static inline void difftest_skip_ref(void) {}
...
static inline void difftest_detach(void) {}
static inline void difftest_attach(void) {}
#endif
...
static inline bool difftest_check_reg(const char *name, vaddr_t pc, word_t ref, word_t dut) {
  if (ref != dut) {
    Error("%s is different after executing instruction at pc = " FMT_WORD ", right = " FMT_WORD
